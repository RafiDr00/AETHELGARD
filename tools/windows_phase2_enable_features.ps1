...
$log = "$PSScriptRoot\windows_phase2_enable_features.log"
...
Run-Step -Name "Enable VirtualMachinePlatform" -Cmd "dism /online /enable-feature /featurename:VirtualMachinePlatform /all"
